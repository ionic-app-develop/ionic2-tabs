...
function templateUpdate(changedFiles, context) {
    try {
        ...
        fs_1.writeFileSync(bundleOutputDest, bundleSourceText, { encoding: 'utf8' });
        // congrats, all gud
...
function updateCorrespondingJsFile(context, newTemplateContent, existingHtmlTemplatePath) {
    var javascriptFiles = context.fileCache.getAll().filter(function (file) { return path_1.dirname(file.path) === path_1.dirname(existingHtmlTemplatePath) && path_1.extname(file.path) === '.js'; });
